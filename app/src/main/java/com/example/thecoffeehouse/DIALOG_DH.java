...
public class DIALOG_DH  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ok_306.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(DIALOG_DH.this, "Đặt Hàng Thành Công", Toast.LENGTH_LONG).show();
                Intent intent = new Intent(DIALOG_DH.this, Dathang.class);
